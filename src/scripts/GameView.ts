class GameView {
    ...
    // separate Walls and Particles, because both need to return arrays to allow
    // erasing
    public renderParticles(particles: Particle[]): Particle[] {
        ...
        for (let particle of retArr) {
            ...
            this.context.fillRect(particle.x, this.HEIGHT - particle.y, 3, 3);
            // }
            // else{
    ...
    public renderWalls(walls: Wall[]): Wall[] {
        ...
        for (let wall of retArr) {
            ...
            this.context.fillRect(wall.x, this.HEIGHT - wall.y, 4, 4);
        }
        return retArr;
    }
}